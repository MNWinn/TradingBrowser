"""
Research Swarm - Continuous Market Analysis Service
...
logging.basicConfig(
    ...
    handlers=[
        ...
        logging.FileHandler('/tmp/research_swarm.log')
    ]
)
logger = logging.getLogger(__name__)

# Add backend to path for imports
sys.path.insert(0, '/home/mnwinnwork/.openclaw/workspace/TradingBrowser')
